...
class LoginActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        edtUserEmail = findViewById(R.id.mEdtEmail)
            ...
            if (userEmail.isEmpty() || userPassword.isEmpty()) {
                ...
                mAuth.signInWithEmailAndPassword(userEmail, userPassword).addOnCompleteListener {
                    ...
                    if (it.isSuccessful){
                        ...
                        startActivity(Intent(this@LoginActivity,PatientsDashBoardActivity::class.java))
                        finish()
                    }else{
        ...
        dash.setOnClickListener {
            ...
            var OpenPage = Intent(this@LoginActivity,PatientsDashBoardActivity
            ::class.java)
