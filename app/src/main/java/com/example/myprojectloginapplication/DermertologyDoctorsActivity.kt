...
class DermertologyDoctorsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        FirstCardView.setOnClickListener {
            ...
            var OpenPage = Intent(this@DermertologyDoctorsActivity,PatientPaymentActivity
            ::class.java)
        ...
        BackButton.setOnClickListener{
            ...
            var OpenPage = Intent(this@DermertologyDoctorsActivity,SpecialitySelectionScrollViewActivity
            ::class.java)
            startActivity(OpenPage)
        ...
        SeeMoreLink.setOnClickListener {
            ...
            var OpenPage = Intent(this@DermertologyDoctorsActivity,DoctorDetailsActivity
            ::class.java)
            startActivity(OpenPage)
