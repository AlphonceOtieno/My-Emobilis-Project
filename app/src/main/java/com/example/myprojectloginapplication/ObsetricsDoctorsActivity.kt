...
class ObsetricsDoctorsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_obsetrics_doctors)
        ...
        FirstCardView.setOnClickListener {
            ...
            var OpenPage = Intent(this@ObsetricsDoctorsActivity,PatientPaymentActivity
            ::class.java)
        ...
        BackButton.setOnClickListener{
            ...
            var OpenPage = Intent(this@ObsetricsDoctorsActivity,SpecialitySelectionScrollViewActivity
            ::class.java)
            startActivity(OpenPage)
        ...
        SeeMoreLink.setOnClickListener {
            ...
            var OpenPage = Intent(this@ObsetricsDoctorsActivity,DoctorDetailsActivity
            ::class.java)
            startActivity(OpenPage)
