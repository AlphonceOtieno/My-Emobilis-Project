...
class PaediatricDoctorsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        FirstCardView.setOnClickListener {
            ...
            var OpenPage = Intent(this@PaediatricDoctorsActivity,PatientPaymentActivity
            ::class.java)
        ...
        BackButton.setOnClickListener{
            ...
            var OpenPage = Intent(this@PaediatricDoctorsActivity,SpecialitySelectionScrollViewActivity
            ::class.java)
            startActivity(OpenPage)
        ...
        SeeMoreLink.setOnClickListener {
            ...
            var OpenPage = Intent(this@PaediatricDoctorsActivity,DoctorDetailsActivity
            ::class.java)
            startActivity(OpenPage)
