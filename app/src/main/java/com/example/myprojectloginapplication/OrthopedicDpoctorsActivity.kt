...
class OrthopedicDpoctorsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        FirstCardView.setOnClickListener {
            ...
            var OpenPage = Intent(this@OrthopedicDpoctorsActivity,PatientPaymentActivity
            ::class.java)
        ...
        BackButton.setOnClickListener{
            ...
            var OpenPage = Intent(this@OrthopedicDpoctorsActivity,SpecialitySelectionScrollViewActivity
            ::class.java)
            startActivity(OpenPage)
        ...
        SeeMoreLink.setOnClickListener {
            ...
            var OpenPage = Intent(this@OrthopedicDpoctorsActivity,DoctorDetailsActivity
            ::class.java)
            startActivity(OpenPage)
