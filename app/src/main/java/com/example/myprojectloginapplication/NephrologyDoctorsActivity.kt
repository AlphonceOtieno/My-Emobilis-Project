...
class NephrologyDoctorsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        FirstCardView.setOnClickListener {
            ...
            var OpenPage = Intent(this@NephrologyDoctorsActivity,PatientPaymentActivity
            ::class.java)
        ...
        BackButton.setOnClickListener{
            ...
            var OpenPage = Intent(this@NephrologyDoctorsActivity,SpecialitySelectionScrollViewActivity
            ::class.java)
            startActivity(OpenPage)
        ...
        SeeMoreLink.setOnClickListener {
            ...
            var OpenPage = Intent(this@NephrologyDoctorsActivity,DoctorDetailsActivity
            ::class.java)
            startActivity(OpenPage)
