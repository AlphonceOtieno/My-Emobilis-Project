...
public final class ActivityObsetricsDoctorsBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityObsetricsDoctorsBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static ActivityObsetricsDoctorsBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityObsetricsDoctorsBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_obsetrics_doctors, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityObsetricsDoctorsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityObsetricsDoctorsBinding((ConstraintLayout) rootView, CardView1, CardView2,
