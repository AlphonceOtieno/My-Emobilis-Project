...
public final class ActivityOrthopedicsDoctorsBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityOrthopedicsDoctorsBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static ActivityOrthopedicsDoctorsBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityOrthopedicsDoctorsBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_orthopedics_doctors, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityOrthopedicsDoctorsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityOrthopedicsDoctorsBinding((ConstraintLayout) rootView, CardView1,
