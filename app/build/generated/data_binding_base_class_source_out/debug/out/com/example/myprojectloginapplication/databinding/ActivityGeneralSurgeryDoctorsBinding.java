...
public final class ActivityGeneralSurgeryDoctorsBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityGeneralSurgeryDoctorsBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static ActivityGeneralSurgeryDoctorsBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityGeneralSurgeryDoctorsBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_general_surgery_doctors, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityGeneralSurgeryDoctorsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityGeneralSurgeryDoctorsBinding((ConstraintLayout) rootView, CardView1,
          CardView2, CardView3, CardView4, CardView5, Doc1, Doc2Image, Doc2Name, Doc2Speciality,
          Doc3Image, Doc3Name, Doc3Speciality, Doc4Image, Doc4Name, Doc4Speciality, Doc5Image,
          Doc5Name, Doc5Speciality, DoctorImage, DoctorName, FloatingActionButton, RelativeLayout,
          ViewMore, ViewMore2, ViewMore3, ViewMore4, ViewMore5, scrollView2, textView, textView2,
          toolbar4);
    }
