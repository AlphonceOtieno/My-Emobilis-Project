...
public final class ActivityDermertologyDoctorsBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityDermertologyDoctorsBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static ActivityDermertologyDoctorsBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityDermertologyDoctorsBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_dermertology_doctors, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityDermertologyDoctorsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityDermertologyDoctorsBinding((ConstraintLayout) rootView, CardView1,
