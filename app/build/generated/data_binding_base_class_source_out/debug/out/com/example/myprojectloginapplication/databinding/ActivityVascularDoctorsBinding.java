...
public final class ActivityVascularDoctorsBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityVascularDoctorsBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static ActivityVascularDoctorsBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityVascularDoctorsBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_vascular_doctors, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityVascularDoctorsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityVascularDoctorsBinding((ConstraintLayout) rootView, CardView1, CardView2,
