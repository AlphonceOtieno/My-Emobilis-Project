...
public final class ActivityOurDoctorsBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityOurDoctorsBinding(@NonNull ConstraintLayout rootView, @NonNull CardView CardView,
  ...
  @NonNull
  public static ActivityOurDoctorsBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityOurDoctorsBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_our_doctors, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityOurDoctorsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityOurDoctorsBinding((ConstraintLayout) rootView, CardView, Doc1, Doc2Image,
