...
public final class ActivityNephrologyDoctorsBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityNephrologyDoctorsBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static ActivityNephrologyDoctorsBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityNephrologyDoctorsBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_nephrology_doctors, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityNephrologyDoctorsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityNephrologyDoctorsBinding((ConstraintLayout) rootView, CardView1, CardView2,
